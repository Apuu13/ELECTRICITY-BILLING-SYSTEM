...
public class delete extends JFrame implements ActionListener,FocusListener{
	...
	public delete() {
		...
		l9=new JLabel("Delete Bill Information");
		l9.setBackground(Color.WHITE);
		l9.setBounds(129,40,371,30);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==b1)
		{
			try
			{
				...
				String q =("delete from customer__info where Miterno='"+s1+"'");
			...
			JOptionPane.showMessageDialog(null, "Information Delete Succesfully");
